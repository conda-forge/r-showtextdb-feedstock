...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-showtextdb-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6985&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-showtextdb-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-showtextdb` can be installed with:

```
conda install r-showtextdb
```

It is possible to list all of the versions of `r-showtextdb` available on your platform with:
